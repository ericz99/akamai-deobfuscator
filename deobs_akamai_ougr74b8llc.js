  ...
  bmak = {
    ...
    gd: function() {
      ...
      var d = Math.random(),
        k = bmak.pi(1e3 * d / 2),
        l = d + "";
      return l = l.slice(0, 11) + k, bmak.get_browser(), bmak.bc(), bmak.bmisc(), a + ",uaend," + bmak.xagg + "," + bmak.psub + "," + bmak.lang + "," + bmak.prod + "," + bmak.plen + "," + bmak.pen + "," + bmak.wen + "," + bmak.den + "," + bmak.z1 + "," + bmak.d3 + "," + n + "," + o + "," + m + "," + r + "," + i + "," + c + "," + b + "," + bmak.bd() + "," + t + "," + l + "," + e + ",loc:" + bmak.loc;
    },
      ...
      try {
        ...
        if (bmak.ke_cnt < bmak.ke_cnt_lmt && e) {
          ...
          var m = e.charCode,
            ...
            l = bmak.gf(null),
            s = 0;
          m && n && (n = 0 != m && 0 != n && m != n ? -1 : 0 != n ? n : m), 0 == i && 0 == c && 0 == b && n >= 32 && (n = 3 == t && n >= 32 && n <= 126 ? -2 : n >= 33 && n <= 47 ? -3 : n >= 112 && n <= 123 ? -4 : -2), l != bmak.prevfid ? (bmak.fidcnt = 0, bmak.prevfid = l) : bmak.fidcnt = bmak.fidcnt + 1;

          if (0 == bmak.isIgn(n)) {
            var u = bmak.ke_cnt + "," + t + "," + k + "," + n + "," + s + "," + d + "," + l;
            null != e.isTrusted && !1 === e.isTrusted && (u += ",0"), u += ";", bmak.kact = bmak.kact + u, bmak.ke_vel = bmak.ke_vel + bmak.ke_cnt + t + k + n + d + l, bmak.ta += k;
          } else o = 0;
        }
    ...
    getforminfo: function() {
      for (var a = "", t = "", e = document.getElementsByTagName("input"), n = -1, o = 0; o < e.length; o++) {
        ...
        null == l ? n = -1 : (l = l.toLowerCase(), n = "off" == l ? 0 : "on" == l ? 1 : 2);
        var s = m.defaultValue,
          u = m.value,
          _ = 0,
          f = 0;
        s && 0 != s.length && (f = 1), !u || 0 == u.length || f && u == s || (_ = 1), 2 != k && (a = a + k + "," + n + "," + _ + "," + b + "," + i + "," + r + "," + f + ";"), t = t + _ + ";";
      }
    ...
    bpd: function() {
      ...
      try {
        ...
        bmak.sensor_data = bmak.sensor_data + "-1,2,-94,-70," + bmak.fpcf["fpValstr"] + "-1,2,-94,-80," + p + "-1,2,-94,-116," + bmak.o9 + "-1,2,-94,-118," + w + "-1,2,-94,-121,", bmak.sd_debug(",s1:" + bmak.sensor_data["slice"](0, 10));
      } catch (a) {
        try {
      ...
      try {
        if (0 == bmak.sdfn["length"]) bmak.sd_debug(",s4"), document.getElementById("sensor_data") && (bmak.sd_debug(",s5"), document.getElementById("sensor_data")["value"] = bmak.sensor_data);
        else {
          bmak.sd_debug(",s6:");

          for (var S = 0; S < bmak.sdfn["length"]; S++)
            if (bmak.sd_debug(",a-" + bmak.sdfn[S]), document.getElementById(bmak.sdfn[S])) {
              bmak.sd_debug(",b"), document.getElementById(bmak.sdfn[S])["value"] = bmak.sensor_data;
    ...
    mn_h: function(a) {
      ...
      for (var c = r.length / 4 + 2, b = Math.ceil(c / 16), d = new Array(b), k = 0; k < b; k++) {
        ...
        for (var l = 0; l < 16; l++) d[k][l] = r.charCodeAt(64 * k + 4 * l) << 24 | r.charCodeAt(64 * k + 4 * l + 1) << 16 | r.charCodeAt(64 * k + 4 * l + 2) << 8 | r.charCodeAt(64 * k + 4 * l + 3) << 0;
      }

      var s = i / Math.pow(2, 32);
      d[b - 1][14] = Math.floor(s), d[b - 1][15] = 4294967295 & i;
    ...
    mn_w: function() {
      try {
        ...
        bmak.mn_mc_indx += 1, bmak.mn_mc_indx < bmak.mn_mc_lmt ? setTimeout(bmak.mn_w, bmak.mn_tout + e) : (bmak.mn_mc_indx = 0, bmak.mn_state = 0, bmak.mn_lc[bmak.mn_lcl] = bmak.mn_cc, bmak.mn_ld[bmak.mn_lcl] = bmak.mn_cd, bmak.mn_lcl = bmak.mn_lcl + 1, bmak.mn_r[bmak.mn_ct] = bmak.mn_pr(), bmak.js_post && (bmak.aj_type = 8, bmak.bpd(), bmak.pd(!0)));
      } catch (a) {
    ...
    a.fpcf = t, t.sf4 = function() {
      ...
      if (!t.sf4()) {
        ...
        for (var l = [], s = 0; s < d.length; s++) {
          ...
          for (c = 0; c < o.length; c++) {
            var b = document.createElement("span");
            b.innerHTML = "abcdefhijklmnopqrstuvxyz1234567890;+-.", b.style["fontSize"] = "90px", b.style["fontFamily"] = d[s] + "," + o[c], u.appendChild(b);
          }
        ...
        for (var s = 0; s < k.childNodes["length"]; s++) {
          ...
          if (_ && l.push(s), bmak.get_cf_date() - e > a) break;
        }

        document.body["removeChild"](k), n = l.sort();
      }
...
try {
  bmak.ir(), bmak.t_tst = bmak.get_cf_date(), bmak.startTracking(), bmak.tst = bmak.get_cf_date() - bmak.t_tst, bmak.disFpCalOnTimeout || setTimeout(bmak.calc_fp, 100);
